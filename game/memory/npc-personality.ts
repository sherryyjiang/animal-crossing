...
const npcPersonalities: Record<NpcPersonalityKey, NpcPersonalityProfile> = {
  bartender: {
    ...
    memoryTypes: ["emotion", "event", "relationship", "task"],
  ...
  shopkeeper: {
    ...
    memoryTypes: ["item", "preference", "schedule", "task"],
  ...
  neighbor: {
    ...
    memoryTypes: ["relationship", "event", "goal", "task"],
  ...
  librarian: {
    ...
    memoryTypes: ["goal", "preference", "event", "task"],
